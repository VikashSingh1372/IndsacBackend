...
public class VendorDetails {
    ...
    public static class VendorDetailsResponse{
        ...
        private VendorDetails.CountInformation count;
        private List<VendorDetails.DueToday> dueToday;
        private List<VendorDetails.OpenItems> openItemsList;
        private VendorDetails.VendorEventList eventList;
    }
    ...
    @AllArgsConstructor
    @NoArgsConstructor
    public static class VendorEventList{
